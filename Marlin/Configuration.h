...
#define PSU_NAME "BTT Relay"
  ...
  //#define AUTO_POWER_CONTROL      // Enable automatic control of the PS_ON pin
    ...
    #define AUTO_POWER_E_TEMP        80 // (°C) PSU on if any extruder is over this temperature
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 139.9
  #define DEFAULT_bedKi 24.62
  #define DEFAULT_bedKd 529.6
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.75, 79.75, 404.4, 139.08 }
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.21 // (mm) Distance from real junction edge
...
#define Z_PROBE_SERVO_NR 0       // Defaults to SERVO 0 connector.
  ...
  #define Z_SERVO_ANGLES { 00, 90 } // Z Servo Deploy and Stow angles
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -55, -1.82 }
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 18
 ...
 */
#define Z_PROBE_END_SCRIPT "G1 Z10 X0 Y0"
